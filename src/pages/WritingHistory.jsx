            ...
            <div className="space-y-4">
              {sessions.map((session) => (
                ...
                >
                  {/* Session header */}
                  <div
                    className="flex items-start justify-between px-8 py-6 cursor-pointer hover:bg-surface-container/40 transition-colors"
                  ...
                  {/* Expanded essay */}
                  {expanded === session.id && (
                    <div className="px-8 pb-8 border-t border-surface-container">
                      ...
                      <div
                        className="text-on-surface text-base leading-[1.8] whitespace-pre-wrap bg-surface-container-low rounded-xl px-8 py-6"
                        style={{
